...
export const asrRateLimiter = new ServerRateLimiter();        // 10 transcriptions per minute per IP
export const ttsRateLimiter = new ServerRateLimiter();        // 10 TTS requests per minute per IP

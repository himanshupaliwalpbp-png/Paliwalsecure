...
export const categoryInfo: CategoryInfo[] = [
  {
    ...
    descriptionHi: 'बढ़ते चिकित्सा खर्चों से अपनी और अपने परिवार की सुरक्षा करें। 14% वार्षिक चिकित्सा मुद्रास्फीति के साथ, स्वास्थ्य बीमा वैकल्पिक नहीं — ज़रूरी है।',
    descriptionHinglish: 'Badhte medical kharcho se apni aur apne parivar ki suraksha karein. 14% annual medical inflation ke saath, health insurance optional nahi — zaroori hai.',
  ...
  },
  {
    ...
    descriptionHi: 'महज़ ₹1,000/माह से शुरू होने वाली ₹1 करोड़+ कवरेज वाली टर्म प्लान से अपने परिवार का वित्तीय भविष्य सुरक्षित करें। शीर्ष बीमाकर्ताओं में CSR 95.55–99.97%.',
    descriptionHinglish: 'Sirf ₹1,000/month se shuru hone wali ₹1 Crore+ cover wali term plan se apne parivar ka financial future secure karein. Top insurers mein CSR 95.55–99.97%.',
  ...
  },
  {
    ...
    descriptionHi: 'आपकी कार के लिए अनिवार्य थर्ड-पार्टी और कॉम्प्रिहेंसिव कवरेज। ₹1,899/वर्ष से कॉम्प्रिहेंसिव, शीर्ष बीमाकर्ताओं में CSR 91–99%.',
    descriptionHinglish: 'Apki car ke liye mandatory third-party aur comprehensive coverage. ₹1,899/yr se comprehensive, top insurers mein CSR 91–99%.',
  ...
  },
  {
    ...
    descriptionHi: 'मेडिकल इमरजेंसी, ट्रिप कैंसिलेशन और खोए सामान के कवरेज के साथ बेचैनी-मुक्त यात्रा — महज़ ₹449/यात्रा से।',
    descriptionHinglish: 'Medical emergency, trip cancellation aur lost baggage ke coverage ke saath worry-free travel — sirf ₹449/trip se.',
  ...
  },
  {
    ...
    name: 'Home Insurance',
    nameHi: 'गृह बीमा',
    nameHinglish: 'Home Insurance',
    icon: 'Home',
    color: '#C98A1C',
    description: 'Protect your home and belongings against fire, theft, natural disasters, and more — starting at just ₹100/month.',
    descriptionHi: 'आग, चोरी, प्राकृतिक आपदा और बहुत कुछ से अपने घर और सामान की सुरक्षा करें — महज़ ₹100/माह से।',
    descriptionHinglish: 'Aag, chori, natural disasters aur bahut kuch se apne ghar aur samaan ki suraksha karein — sirf ₹100/month se.',
...
export interface ComplianceItem {
  ...
  requirement: string;
  description: string;
  status: 'required' | 'recommended' | 'future' | 'compliant';
...
// ============================================================================
// ADD-ONS & RIDERS — Comprehensive Coverage Enhancement Data
// ============================================================================
...
export interface AddonRider {
  ...
  descriptionHi: string;
  cost: string;
  costType: 'monthly' | 'yearly' | 'one-time' | 'percentage';
  benefit: string;
  benefitHi: string;
  whoNeedsIt: string;
  whoNeedsItHi: string;
...
export const addonsRiders: AddonRider[] = [
  // ── HEALTH INSURANCE ADD-ONS ─────────────────────────────────────────────
  {
    ...
    category: 'health',
    type: 'addon',
    description: 'Additional coverage layer above your base policy. If base policy sum insured exhausts, super top-up kicks in for remaining expenses.',
    descriptionHi: 'Base policy ke upar extra coverage layer. Agar base sum insured khatam ho gaya, toh super top-up baaki kharcha cover karega.',
    cost: '₹300-500/month',
    costType: 'monthly',
    benefit: '₹25L-₹1Cr additional coverage at very low premium',
    benefitHi: '₹25L-₹1Cr extra coverage bahut kam premium mein',
    whoNeedsIt: 'Families with ₹5L-₹10L base plan in metro cities where hospital bills easily exceed base sum insured',
    whoNeedsItHi: 'Metro cities ke families jinke paas ₹5L-₹10L base plan hai jahan hospital bills base sum insured se zyada ho sakte hain',
    availableWith: ['HDFC ERGO', 'Niva Bupa', 'Care Health', 'Star Health'],
    importantNotes: ['Deductible applies (usually equal to base sum insured)', 'Can be from different insurer than base plan', 'Tax benefit under Section 80D'],
    recommended: true,
  },
  {
    id: 'health-addon-002',
    ...
    category: 'health',
    type: 'addon',
    description: 'Covers expenses related to pregnancy, delivery (normal & C-section), pre and post-natal care, and newborn baby expenses.',
    descriptionHi: 'Pregnancy, delivery (normal aur C-section), pre/post-natal care, aur newborn baby ke kharche cover hota hai.',
    cost: '₹200-400/month extra',
    costType: 'monthly',
    benefit: 'Normal delivery: ₹15,000-₹50,000 | C-Section: ₹25,000-₹75,000 | Newborn cover for 90 days',
    benefitHi: 'Normal delivery: ₹15K-₹50K | C-Section: ₹25K-₹75K | Newborn 90 din tak covered',
    whoNeedsIt: 'Couples planning pregnancy within next 1-4 years. Must buy before conception for waiting period to complete.',
    whoNeedsItHi: 'Couples jo 1-4 saal mein pregnancy plan kar rahe hain. Conception se pehle khareedein taaki waiting period complete ho.',
    availableWith: ['Star Health', 'HDFC ERGO', 'Niva Bupa', 'Care Health'],
    importantNotes: ['Waiting period: 9 months to 4 years', 'Sub-limits apply on delivery expenses', 'Newborn cover starts after 90 days generally'],
    recommended: true,
  },
  {
    id: 'health-addon-003',
    ...
    category: 'health',
    type: 'addon',
    description: 'Removes the room rent capping limit. Without this, choosing an expensive room leads to proportional deduction in ALL treatment costs, not just room rent.',
    descriptionHi: 'Room rent ki limit hata deta hai. Bina iske mehnga room choose karne par SABHI treatment costs mein proportional deduction hota hai.',
    cost: '₹100-200/month extra',
    costType: 'monthly',
    benefit: 'Choose any room category without financial penalty — no proportional deduction on surgery, doctor fees, etc.',
    benefitHi: 'Koi bhi room category choose karein bina financial penalty ke — surgery, doctor fees pe koi deduction nahi.',
    whoNeedsIt: 'Anyone who prefers private/deluxe rooms in hospitals. Critical for metro city hospital stays.',
    whoNeedsItHi: 'Jo log private/deluxe rooms prefer karte hain. Metro cities mein bahut important.',
    availableWith: ['ACKO', 'Niva Bupa', 'HDFC ERGO', 'Care Health'],
    importantNotes: ['Without waiver, room rent limit affects ALL hospital bills proportionally', 'Must-have for policies with room rent sub-limits'],
    recommended: true,
  },
  {
    id: 'health-addon-004',
    name: 'PED Waiver (Pre-Existing Disease)',
    category: 'health',
    type: 'addon',
    description: 'Reduces the waiting period for pre-existing diseases from 24-48 months to as low as 12 months or even Day 1 coverage.',
    descriptionHi: 'Pre-existing diseases ka waiting period 24-48 mahine se 12 mahine ya Day 1 tak reduce karta hai.',
    cost: '₹150-300/month extra',
    costType: 'monthly',
    benefit: 'Coverage for diabetes, BP, heart disease starts from Day 1 or within 12 months instead of 2-4 years',
    benefitHi: 'Diabetes, BP, heart disease ka cover Day 1 ya 12 mahine mein shuru hota hai 2-4 saal ki jagah',
    whoNeedsIt: 'People with diabetes, hypertension, heart disease, thyroid, or any pre-existing condition',
    whoNeedsItHi: 'Jo logon ko diabetes, BP, heart disease, thyroid ya koi pre-existing condition hai',
    availableWith: ['Aditya Birla Health', 'Star Health', 'Care Health'],
    importantNotes: ['Not available with all insurers', 'Medical screening may be required', 'Premium loading may apply based on condition'],
    recommended: true,
  },
  {
    id: 'health-addon-005',
    ...
    category: 'health',
    type: 'addon',
    description: 'Lump sum payout on diagnosis of specified critical illnesses like cancer, heart attack, stroke, kidney failure — regardless of hospitalization expenses.',
    descriptionHi: 'Critical illness (cancer, heart attack, stroke, kidney failure) diagnosis par lump sum amount milta hai — hospitalization ki zaroorat nahi.',
    cost: '₹200-400/month',
    costType: 'monthly',
    benefit: '₹5L-₹50L lump sum on diagnosis of 30-40 critical illnesses. Money can be used for anything — treatment, EMI, lifestyle.',
    benefitHi: '₹5L-₹50L lump sum diagnosis par. Paisa kuch bhi ke liye use kar sakte hain — treatment, EMI, lifestyle.',
    whoNeedsIt: 'Sole earners, people with family history of critical illness, anyone above 35 years',
    whoNeedsItHi: 'Sole earners, critical illness ki family history wale, 35+ age ke log',
    availableWith: ['HDFC ERGO', 'ICICI Lombard', 'TATA AIG', 'Star Health'],
    importantNotes: ['Separate from health insurance — pays regardless of actual hospital bill', 'Survival period of 30 days after diagnosis usually required', 'List of covered illnesses varies by insurer'],
    recommended: true,
  },
  {
    id: 'health-addon-006',
    name: 'Hospital Cash / Daily Allowance',
    category: 'health',
    type: 'addon',
    description: 'Fixed daily cash allowance for each day of hospitalization, regardless of actual expenses. Covers non-medical costs like food, travel, lost income.',
    descriptionHi: 'Har hospitalization day par fixed cash allowance, actual kharche se independent. Non-medical costs jaise khana, travel, lost income cover hota hai.',
    cost: '₹100-150/month',
    costType: 'monthly',
    benefit: '₹1,000-₹5,000 per day for each day of hospitalization, typically up to 30-60 days',
    benefitHi: '₹1,000-₹5,000 per day hospitalization ke liye, generally 30-60 din tak',
    whoNeedsIt: 'Self-employed, daily wage workers, anyone who loses income during hospitalization',
    whoNeedsItHi: 'Self-employed, daily wage workers, jo hospitalization mein income kho dete hain',
    availableWith: ['Star Health', 'Care Health', 'HDFC ERGO'],
    importantNotes: ['Paid in addition to regular health insurance claim', 'Usually requires minimum 24-48 hours hospitalization', 'ICU admission may get double the daily amount'],
    recommended: false,
  },
  {
    id: 'health-addon-007',
    ...
    category: 'health',
    type: 'addon',
    description: 'If your sum insured is exhausted during the policy year, this benefit restores it (100% or unlimited) for future claims in the same year.',
    descriptionHi: 'Agar policy year mein sum insured khatam ho gaya, toh yeh benefit use restore kar deta hai (100% ya unlimited) usi year ke future claims ke liye.',
    cost: '₹100-250/month extra',
    costType: 'monthly',
    benefit: '100% sum insured restoration, some plans offer unlimited restoration for unrelated illnesses',
    benefitHi: '100% sum insured wapas, kuch plans mein unrelated illnesses ke liye unlimited restoration',
    whoNeedsIt: 'Families with moderate sum insured who may have multiple hospitalizations in a year',
    whoNeedsItHi: 'Families jinke moderate sum insured hai aur saal mein multiple hospitalizations ho sakti hain',
    availableWith: ['HDFC ERGO', 'Niva Bupa', 'Care Health'],
    importantNotes: ['Usually restores for different illness only, not same illness', 'Some plans offer unlimited restoration', 'Must-have for family floater policies'],
    recommended: true,
  },
  {
    id: 'health-addon-008',
    name: 'AYUSH Treatment Cover',
    category: 'health',
    type: 'addon',
    description: 'Covers Ayurveda, Yoga, Unani, Siddha, and Homeopathy treatments. Some plans include this by default, others offer as add-on.',
    descriptionHi: 'Ayurveda, Yoga, Unani, Siddha, aur Homeopathy treatments cover hote hain. Kuch plans mein default hai, doosron mein add-on hai.',
    cost: '₹50-100/month extra',
    costType: 'monthly',
    benefit: 'Coverage for alternative medicine treatments at recognized AYUSH hospitals',
    benefitHi: 'Recognized AYUSH hospitals mein alternative medicine treatments ka coverage',
    whoNeedsIt: 'People who prefer or regularly use alternative medicine treatments',
    whoNeedsItHi: 'Jo log alternative medicine treatments prefer ya regularly use karte hain',
    availableWith: ['Care Health', 'Star Health', 'HDFC ERGO'],
    importantNotes: ['IRDAI mandates AYUSH coverage in all health plans from 2024', 'Only at recognized AYUSH hospitals', 'Sub-limits may apply'],
    recommended: false,
  },
  // ── LIFE INSURANCE RIDERS ──────────────────────────────────────────────
  {
    ...
    category: 'life',
    type: 'rider',
    description: 'Pays a lump sum amount on diagnosis of specified critical illnesses (cancer, heart attack, stroke, etc.) in addition to the base life cover.',
    descriptionHi: 'Specified critical illnesses (cancer, heart attack, stroke, etc.) ki diagnosis par lump sum amount milta hai base life cover ke alawa.',
    cost: '₹200-400/month extra',
    costType: 'monthly',
    benefit: '₹10L-₹1Cr lump sum on diagnosis of 30-40 critical illnesses — paid regardless of treatment cost',
    benefitHi: '₹10L-₹1Cr lump sum diagnosis par — treatment cost se independent',
    whoNeedsIt: 'Everyone with dependents, especially sole earners and people with family history of critical illness',
    whoNeedsItHi: 'Sabhi dependent wale log, especially sole earners aur critical illness ki family history wale',
    availableWith: ['HDFC Life', 'Max Life', 'ICICI Prudential', 'SBI Life', 'Bajaj Allianz Life', 'Tata AIA Life'],
    importantNotes: ['Survival period of 30 days usually required after diagnosis', 'Claim does not reduce life cover amount', 'List of covered illnesses varies by insurer'],
    recommended: true,
  },
  {
    id: 'life-rider-002',
    ...
    category: 'life',
    type: 'rider',
    description: 'Provides additional payout (on top of base sum assured) if death occurs due to an accident. Typically 1x-2x of base cover.',
    descriptionHi: 'Accident se death hone par additional payout milta hai (base sum assured ke upar). Generally base cover ka 1x-2x.',
    cost: '₹100-200/month extra',
    costType: 'monthly',
    benefit: 'Additional ₹50L-₹2Cr on accidental death, over and above base term cover',
    benefitHi: 'Accidental death par additional ₹50L-₹2Cr, base term cover ke upar',
    whoNeedsIt: 'People with high commuting/travel risk, young professionals, construction/factory workers',
    whoNeedsItHi: 'High commuting/travel risk wale, young professionals, construction/factory workers',
    availableWith: ['HDFC Life', 'Max Life', 'ICICI Prudential', 'SBI Life', 'Bajaj Allianz Life', 'Tata AIA Life', 'LIC'],
    importantNotes: ['Death must be directly caused by accident', 'Usually excludes adventure sports, DUI, etc.', 'Must be added at policy purchase time in most cases'],
    recommended: true,
  },
  {
    id: 'life-rider-003',
    ...
    category: 'life',
    type: 'rider',
    description: 'Future premiums are waived off if the policyholder is diagnosed with critical illness or becomes permanently disabled. Policy continues with full benefits.',
    descriptionHi: 'Agar policyholder ko critical illness hogi ya permanently disabled hoga, toh future premiums maaf ho jayenge. Policy full benefits ke saath jaari rahegi.',
    cost: '₹100-150/month extra',
    costType: 'monthly',
    benefit: 'All future premiums waived — policy continues with full sum assured and benefits',
    benefitHi: 'Saare future premiums maaf — policy full sum assured aur benefits ke saath jaari rahegi',
    whoNeedsIt: 'Sole earners, anyone whose family would struggle to pay premiums after disability/illness',
    whoNeedsItHi: 'Sole earners, jinki family disability/illness ke baad premium pay karne mein mushkil hogi',
    availableWith: ['HDFC Life', 'Max Life', 'ICICI Prudential', 'SBI Life', 'Bajaj Allianz Life', 'Tata AIA Life'],
    importantNotes: ['Triggers on critical illness diagnosis OR permanent disability', 'Policy continues as if premiums are being paid', 'Very valuable for long-term policies (20-40 years)'],
    recommended: true,
  },
  {
    id: 'life-rider-004',
    ...
    category: 'life',
    type: 'rider',
    description: 'Provides monthly income or lump sum if the policyholder suffers permanent total/partial disability due to an accident.',
    descriptionHi: 'Agar policyholder ko accident se permanent total/partial disability hoti hai, toh monthly income ya lump sum milta hai.',
    cost: '₹150-250/month extra',
    costType: 'monthly',
    benefit: 'Monthly income of ₹20,000-₹1,00,000 for 10-15 years OR lump sum of ₹10L-₹1Cr on permanent disability',
    benefitHi: '₹20K-₹1L monthly income 10-15 saal ke liye YA ₹10L-₹1Cr lump sum permanent disability par',
    whoNeedsIt: 'People in high-risk occupations, frequent travelers, two-wheeler riders',
    whoNeedsItHi: 'High-risk occupation wale, frequent travelers, two-wheeler riders',
    availableWith: ['HDFC Life', 'Max Life', 'ICICI Prudential', 'Tata AIA Life'],
    importantNotes: ['Different payouts for total vs partial disability', 'Usually excludes self-inflicted injuries', 'Disability must be certified by insurer-approved doctor'],
    recommended: false,
  },
  {
    id: 'life-rider-005',
    ...
    category: 'life',
    type: 'rider',
    description: 'Provides monthly income to the family for 10-15 years after the policyholder\'s death, in addition to the lump sum death benefit.',
    descriptionHi: 'Policyholder ki death ke baad 10-15 saal tak family ko monthly income milta hai, lump sum death benefit ke alawa.',
    cost: '₹200-300/month extra',
    costType: 'monthly',
    benefit: 'Monthly income of ₹20,000-₹1,00,000 for 10-15 years after death, in addition to lump sum',
    benefitHi: 'Death ke baad ₹20K-₹1L monthly income 10-15 saal tak, lump sum ke alawa',
    whoNeedsIt: 'Sole earners with dependents who need regular income replacement, not just lump sum',
    whoNeedsItHi: 'Sole earners jinke dependents ko regular income chahiye, sirf lump sum nahi',
    availableWith: ['HDFC Life', 'Max Life', 'ICICI Prudential'],
    importantNotes: ['Income is in addition to base sum assured', 'Taxable as income for the recipient', 'Great for families with EMIs and regular expenses'],
    recommended: false,
  },
  // ── MOTOR INSURANCE ADD-ONS ────────────────────────────────────────────
  {
    ...
    category: 'motor',
    type: 'addon',
    description: 'Full claim settlement without deducting depreciation on parts. Without this, you bear 30-50% cost of plastic, fiber, rubber, and glass parts.',
    descriptionHi: 'Full claim settlement bina depreciation deduct kiye. Bina iske plastic, fiber, rubber, glass parts ka 30-50% kharcha aapko dena padega.',
    cost: '15-20% of own damage premium',
    costType: 'percentage',
    benefit: '100% cost of replaced parts covered — no depreciation deduction on plastic, metal, glass, or rubber parts',
    benefitHi: 'Replaced parts ka 100% cost covered — plastic, metal, glass, rubber parts pe koi depreciation nahi',
    whoNeedsIt: 'New cars (less than 3-5 years), luxury vehicles, inexperienced drivers, anyone who wants full claim settlement',
    whoNeedsItHi: 'Nayi gaadi (3-5 saal se kam), luxury vehicles, inexperienced drivers, jo full claim settlement chahte hain',
    availableWith: ['ICICI Lombard', 'HDFC ERGO', 'Bajaj Allianz', 'ACKO'],
    importantNotes: ['Usually available only for cars up to 5-7 years old', 'Most popular motor add-on in India', 'Can be claimed limited times (usually 2 per year)'],
    recommended: true,
  },
  {
    id: 'motor-addon-002',
    ...
    category: 'motor',
    type: 'addon',
    description: 'Covers damage to engine and gearbox due to water ingression (flooding), hydrostatic lock, and lubricant leakage. Not covered in standard comprehensive.',
    descriptionHi: 'Flood/water se engine aur gearbox ka nuksan cover hota hai — hydrostatic lock, water ingression, lubricant leakage. Standard comprehensive mein nahi milta.',
    cost: '₹500-₹1,500/year extra',
    costType: 'yearly',
    benefit: 'Engine replacement or repair cost covered — can be ₹50,000-₹3,00,000 depending on car',
    benefitHi: 'Engine replacement ya repair cost covered — ₹50K-₹3L tak gaadi pe depend karta hai',
    whoNeedsIt: 'People in flood-prone areas, monsoon season drivers, luxury car owners',
    whoNeedsItHi: 'Flood-prone areas ke log, monsoon season drivers, luxury car owners',
    availableWith: ['ICICI Lombard', 'HDFC ERGO', 'Bajaj Allianz'],
    importantNotes: ['Must be added at policy purchase/renewal', 'Does not cover consequential damage from continued driving', 'Critical for Mumbai, Chennai, and flood-prone cities'],
    recommended: true,
  },
  {
    id: 'motor-addon-003',
    ...
    category: 'motor',
    type: 'addon',
    description: '24/7 emergency assistance for breakdowns — towing, flat tire, battery jumpstart, fuel delivery, key lockout help.',
    descriptionHi: '24/7 emergency help breakdown ke liye — towing, puncture, battery jumpstart, fuel delivery, key lockout.',
    cost: '₹300-₹800/year extra',
    costType: 'yearly',
    benefit: 'Free towing up to 25-50km, on-site minor repairs, fuel delivery, accommodation assistance',
    benefitHi: 'Free towing 25-50km tak, on-site minor repairs, fuel delivery, accommodation assistance',
    whoNeedsIt: 'Everyone — especially highway drivers, long-distance travelers, and people with older cars',
    whoNeedsItHi: 'Sabhi ke liye — especially highway drivers, long-distance travelers, aur purani gaadi wale',
    availableWith: ['ICICI Lombard', 'HDFC ERGO', 'Bajaj Allianz'],
    importantNotes: ['Number of service calls may be limited', 'Towing distance limit applies', 'Available 24/7 across India'],
    recommended: true,
  },
  {
    id: 'motor-addon-004',
    ...
    category: 'motor',
    type: 'addon',
    description: 'In case of total loss or theft, you receive the original invoice value of the car (including registration, road tax) instead of depreciated IDV.',
    descriptionHi: 'Total loss ya theft hone par original invoice value milta hai (registration, road tax ke saath) depreciated IDV ki jagah.',
    cost: '₹500-₹1,200/year extra',
    costType: 'yearly',
    benefit: 'Full invoice value including road tax and registration — can be ₹1-5L more than IDV on new cars',
    benefitHi: 'Full invoice value road tax aur registration ke saath — nayi gaadi mein IDV se ₹1-5L zyada mil sakta hai',
    whoNeedsIt: 'New car owners (within 3 years), people in theft-prone areas, anyone with high-value cars',
    whoNeedsItHi: 'Nayi gaadi wale (3 saal ke andar), theft-prone areas ke log, high-value cars wale',
    availableWith: ['ICICI Lombard', 'HDFC ERGO', 'Bajaj Allianz'],
    importantNotes: ['Available only for cars up to 3 years old', 'Covers ex-showroom price + registration + road tax', 'Essential for new car buyers'],
    recommended: true,
  },
  {
    id: 'motor-addon-005',
    ...
    category: 'motor',
    type: 'addon',
    description: 'Covers cost of consumables like engine oil, gearbox oil, brake fluid, coolant, AC gas, nuts, bolts, and screws during accident repairs.',
    descriptionHi: 'Accident repair mein consumables jaise engine oil, brake fluid, coolant, AC gas, nuts, bolts ka kharcha cover hota hai.',
    cost: '₹300-₹600/year extra',
    costType: 'yearly',
    benefit: '₹2,000-₹10,000 worth of consumables covered per claim that would otherwise come out of your pocket',
    benefitHi: '₹2,000-₹10,000 ke consumables per claim covered jo otherwise aapki jeb se aate',
    whoNeedsIt: 'All car owners — consumables can add up to ₹5,000-₹10,000 per accident repair',
    whoNeedsItHi: 'Sabhi car owners — consumables ₹5K-₹10K tak ho sakte hain per accident repair',
    availableWith: ['Bajaj Allianz', 'ICICI Lombard', 'HDFC ERGO'],
    importantNotes: ['Not covered in standard comprehensive policy', 'Applies only during accident repairs, not regular maintenance', 'Small add-on but saves hassle during claims'],
    recommended: false,
  },
  {
    id: 'motor-addon-006',
    ...
    category: 'motor',
    type: 'addon',
    description: 'Protects your No Claim Bonus even if you make a claim during the policy year. Without this, one claim resets your NCB to 0%.',
    descriptionHi: 'Claim karne ke baad bhi NCB safe rehta hai. Bina iske ek claim se NCB 0% ho jata hai.',
    cost: '₹500-₹1,000/year extra',
    costType: 'yearly',
    benefit: 'Preserves 20-50% NCB discount even after claims — saves ₹2,000-₹10,000 on renewal premium',
    benefitHi: 'Claim ke baad bhi 20-50% NCB discount bacha rehta hai — renewal premium mein ₹2K-₹10K bachate hain',
    whoNeedsIt: 'Drivers with 40-50% NCB who want to protect their discount, people who drive in high-traffic areas',
    whoNeedsItHi: '40-50% NCB wale drivers jo discount bachana chahte hain, high-traffic areas mein chalane wale',
    availableWith: ['ICICI Lombard', 'HDFC ERGO', 'Bajaj Allianz'],
    importantNotes: ['Usually allows 1-2 claims per year without losing NCB', 'Only protects current NCB, does not increase it', 'Very cost-effective for high NCB holders'],
    recommended: true,
  },
  {
    id: 'motor-addon-007',
    name: 'Personal Accident Cover for Passengers',
    category: 'motor',
    type: 'addon',
    description: 'Covers accidental death and disability for passengers in your car. Base policy only covers owner-driver by default.',
    descriptionHi: 'Gaadi ke passengers ke liye accidental death aur disability cover. Base policy mein sirf owner-driver cover hota hai.',
    cost: '₹200-₹500/year extra',
    costType: 'yearly',
    benefit: '₹1L-₹10L per passenger for accidental death/disability — covers up to 4-6 passengers',
    benefitHi: '₹1L-₹10L per passenger accidental death/disability ke liye — 4-6 passengers tak cover',
    whoNeedsIt: 'Everyone who regularly carries family/friends in their car',
    whoNeedsItHi: 'Sabhi jo regularly family/friends ko gaadi mein le jaate hain',
    availableWith: ['ICICI Lombard', 'HDFC ERGO', 'Bajaj Allianz'],
    importantNotes: ['Base comprehensive only covers owner-driver PA', 'Legally mandated for commercial vehicles', 'Must-have if you regularly drive with family'],
    recommended: true,
  },
];
...
// ============================================================================
// GRIEVANCE & FRAUD DATA — Source: IRDAI Annual Report FY25
// ============================================================================
...
// Source: IRDAI Annual Report FY25 — Complaint data for health insurers
export const insurerGrievanceData: GrievanceData[] = [
  {
    insurer: 'Star Health',
    grievances: 20527,
    percentChange: 22,
...
// Fraud estimate — Source: Industry estimates referenced in IRDAI reports
export const FRAUD_ESTIMATE = {
  percentageMin: 10,
  percentageMax: 15,
  description: '~10-15% of industry claims estimated as fraudulent',
  source: 'Industry estimates per IRDAI reports',
  isReferenceOnly: true,
};

// Mis-selling commission data — Source: Public disclosures
export const MISSELLING_ALERT_DATA = {
  bankCommissions: [
    { entity: 'HDFC Bank', commission: 6467, unit: 'Cr' }, // ₹6,467 Cr
  ],
  warningMessage: 'Be aware of high-commission products pushed by agents. Always compare before buying.',
  isEducationalOnly: true,
};

// IRDAI Moratorium & Policyholder Rights — Source: IRDAI Regulations 2025-26
export const POLICYHOLDER_RIGHTS = {
  moratorium: {
    years: 5,
    description: 'After 5 continuous years of coverage, no claim can be rejected for non-disclosure (except fraud).',
    source: 'IRDAI Regulations 2025-26',
  },
  cashlessTimeline: {
    preAuthHours: 1,
    dischargeHours: 3,
    description: 'Pre-authorisation within 1 hour of document receipt; discharge approval within 3 hours of final bill.',
    source: 'IRDAI mandate',
  },
  ombudsman: {
    maxClaimAmount: 5000000, // ₹50 Lakh
    steps: [
      'Step 1: Grievance Redressal Officer (insurer internal)',
      'Step 2: Bima Bharosa Portal (IRDAI online platform)',
      'Step 3: Insurance Ombudsman (for claims up to ₹50L)',
    ],
    source: 'IRDAI Grievance Redressal Process',
  },
  portability: {
    description: 'You can switch insurers without resetting PED waiting periods. IRDAI mandates seamless portability.',
    source: 'IRDAI Portability Regulations',
  },
};

// Motor TP Rates — Source: IRDAI Motor Tariff FY25
export const MOTOR_TP_RATES = {
  rates: [
    { ccBracket: 'sub-1000cc', amount: 2094 },
    { ccBracket: '1000-1500cc', amount: 3316 },
    { ccBracket: 'above-1500cc', amount: 7789 },
  ],
  bikeRate: 1366,
  upcomingIncreaseWarning: '18-25% increase expected soon',
  source: 'IRDAI Motor Third-Party Premium Rates FY25',
};

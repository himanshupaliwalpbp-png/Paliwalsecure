                ...
                >
                  {filteredGlossary.map((item) => (
                    ...
                    >
                      ...
                      <Link
                        href={`/knowledge/${item.slug || item.term.toLowerCase().replace(/\s+/g, '-')}`}
                        className="text-[10px] text-[#C98A1C] dark:text-[#C98A1C] font-medium hover:underline inline-flex items-center gap-1"
                      >

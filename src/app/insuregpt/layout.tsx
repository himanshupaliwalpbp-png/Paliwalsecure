...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: 'https://paliwalsecure.in/og-image.png', width: 1200, height: 630, alt: 'InsureGPT — AI Insurance Chatbot by Paliwal Secure' }],
  },
  twitter: {
    ...
    images: ['https://paliwalsecure.in/og-image.png'],

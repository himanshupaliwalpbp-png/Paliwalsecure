  ...
  sections: [
    ...
    },
    {
      ...
      items: [
        ...
        { title: { en: 'IRDAI Bima Bharosa', hi: 'IRDAI बीमा भरोसा', hinglish: 'IRDAI Bima Bharosa' }, desc: { en: 'Lodge a complaint with IRDAI at bimabharosa.irdai.gov.in or call 1800-258-1111 (Toll Free) for insurance-related grievances.', hi: 'बीमा से संबंधित शिकायतों के लिए bimabharosa.irdai.gov.in पर IRDAI में शिकायत दर्ज करें या 1800-258-1111 (टोल फ्री) पर कॉल करें।', hinglish: 'Insurance-related grievances ke liye bimabharosa.irdai.gov.in pe IRDAI mein complaint lodge karein ya 1800-258-1111 (Toll Free) pe call karein.' } },

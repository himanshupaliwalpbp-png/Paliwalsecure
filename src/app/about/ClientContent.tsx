...
const pageText = {
  ...
  founder: {
    ...
    desc: { en: 'Himanshu Paliwal is an IRDAI‑registered POSP based in Kota, Rajasthan. With deep expertise in insurance advisory and a passion for making insurance accessible to every Indian family, he founded Paliwal Secure AI to bridge the gap between complex insurance products and everyday Indians who need simple, trustworthy guidance.', hi: 'हिमांशु पालीवाल कोटा, राजस्थान में आधारित IRDAI पंजीकृत POSP हैं। बीमा सलाहकार में गहन विशेषज्ञता के साथ, उन्होंने Paliwal Secure AI की स्थापना जटिल बीमा उत्पादों और रोज़मर्रा के भारतीयों के बीच की खाई को पाटने के लिए की — ताकि हर परिवार को सरल और भरोसेमंद मार्गदर्शन मिले।', hinglish: 'Himanshu Paliwal Kota, Rajasthan mein based IRDAI registered POSP hain. Insurance advisory mein deep expertise ke saath, unhone Paliwal Secure AI ki sthapana complex insurance products aur everyday Indians ke beech ki khai ko paane ke liye ki — taaki har family ko simple aur bharosemand margdarshan mile.' },
    location: { en: 'Kota, Rajasthan', hi: 'कोटा, राजस्थान', hinglish: 'Kota, Rajasthan' },
  ...
  story: {
    ...
    solution: { en: 'Paliwal Secure AI was founded by Himanshu Paliwal in Kota to solve this exact problem. Using AI‑powered comparison technology and InsureGPT — India\'s first Hinglish insurance AI — we make it possible for any Indian to find the right insurance in minutes, not weeks.', hi: 'हिमांशु पालीवाल ने कोटा में Paliwal Secure AI की स्थापना इसी समस्या को हल करने के लिए की। AI-संचालित तुलना तकनीक और InsureGPT के साथ, हर भारतीय को मिनटों में सही बीमा मिल सकता है।', hinglish: 'Himanshu Paliwal ne Kota mein Paliwal Secure AI ki sthapana isi problem ko hal karne ke liye ki. AI-powered comparison tech aur InsureGPT ke saath, koi bhi Indian minutes mein sahi insurance pa sakta hai.' },
  ...
  milestones: [
    ...
    { year: '2025', title: { en: '500+ Families', hi: '500+ परिवार', hinglish: '500+ Families' }, desc: { en: 'Trusted by 500+ Indian families across Kota, Delhi, Mumbai & 50+ cities. Growing every day.', hi: 'कोटा, दिल्ली, मुंबई और 50+ शहरों में 500+ भारतीय परिवारों का भरोसा। हर दिन बढ़ते जा रहे हैं।', hinglish: 'Kota, Delhi, Mumbai & 50+ cities mein 500+ Indian families ka bharosa. Har din badh rahe hain.' } },
  ],
  contact: {
    ...
    locationVal: { en: 'Kota, Rajasthan', hi: 'कोटा, राजस्थान', hinglish: 'Kota, Rajasthan' },

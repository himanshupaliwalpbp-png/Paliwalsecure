...
const pageText = {
  ...
  appeal: {
    ...
    steps: [
      ...
      { title: { en: "Escalate to IRDAI Bima Bharosa Portal", hi: "IRDAI बीमा भरोसा पोर्टल पर एस्केलेट करें", hinglish: "IRDAI Bima Bharosa Portal Pe Escalate Karein" }, description: { en: "If not satisfied, register complaint on IRDAI's centralized portal. Insurers must respond within 15 days.", hi: "असंतुष्ट हों तो IRDAI के केंद्रीकृत पोर्टल पर शिकायत दर्ज करें। बीमाकर्ताओं को 15 दिन में जवाब देना चाहिए।", hinglish: "Unsatisfied ho toh IRDAI ke centralized portal pe complaint darj karein. Insurers ko 15 din mein respond karna chahiye." }, contact: { en: "https://bimabharosa.irda.gov.in | Toll-free: 1800-258-1111", hi: "https://bimabharosa.irda.gov.in | टोल-फ्री: 1800-258-1111", hinglish: "https://bimabharosa.irda.gov.in | Toll-free: 1800-258-1111" } },
  ...
  help: {
    ...
    helplineNum: { en: "1800-258-1111", hi: "1800-258-1111", hinglish: "1800-258-1111" },

...
export const metadata: Metadata = {
  title: 'Travel Insurance India 2026: Complete Guide',
  description: 'Complete travel insurance guide India 2026. Compare plans, premiums, CSR. 4+ articles. By IRDAI POSP IP429834.',
  alternates: { canonical: 'https://paliwalsecure.in/pillar/travel-insurance' },
};

export default function PillarPage() {
  const title2 = 'Travel Insurance India 2026: Complete Guide';
  const text2 = 'travel insurance';
  
  return (
    <div className="min-h-screen bg-gradient-to-b from-background to-muted/10">
      <BreadcrumbSchema items={[
        { name: 'Home', url: 'https://paliwalsecure.in' },
        { name: 'Travel Insurance India 2026', url: 'https://paliwalsecure.in/pillar/travel-insurance' },
      ]} />

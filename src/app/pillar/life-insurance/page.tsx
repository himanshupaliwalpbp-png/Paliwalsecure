...
export const metadata: Metadata = {
  title: 'Life Insurance & Term Plans India 2026: Guide',
  description: 'Complete life insurance guide India 2026. Compare plans, premiums, CSR. 18+ articles. By IRDAI POSP IP429834.',
  alternates: { canonical: 'https://paliwalsecure.in/pillar/life-insurance' },
};

export default function PillarPage() {
  const title2 = 'Life Insurance & Term Plans India 2026: Guide';
  const text2 = 'life insurance';
  
  return (
    <div className="min-h-screen bg-gradient-to-b from-background to-muted/10">
      <BreadcrumbSchema items={[
        { name: 'Home', url: 'https://paliwalsecure.in' },
        { name: 'Life Insurance & Term Plans India 2026', url: 'https://paliwalsecure.in/pillar/life-insurance' },
      ]} />
      ...
      <section className="py-16 md:py-24">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-base md:text-lg text-muted-foreground max-w-2xl mx-auto mb-8">
            India&apos;s most comprehensive {text2} guide. 18+ articles. Real IRDAI data, expert insights.
          </p>
        ...
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            <Link href="/blog" className="block p-4 rounded-lg bg-card border border-border/50 hover:border-primary/30 transition-all">
              ...
              <p className="text-xs text-muted-foreground mt-1">18+ in-depth articles with real IRDAI data</p>
            </Link>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <div className="text-sm text-muted-foreground leading-relaxed space-y-3">
                  <p>
                    This pillar guide consolidates 18+ articles into one authoritative resource.

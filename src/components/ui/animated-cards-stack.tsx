...
const cardVariants = cva("absolute will-change-transform", {
  variants: {
    variant: {
      dark: "flex size-full flex-col items-center justify-center gap-5 rounded-2xl border border-[rgba(201,138,28,0.18)] bg-[#111B3D]/90 p-5 backdrop-blur-md shadow-[0_0_20px_rgba(126,211,230,0.04)]",
      light:
        "flex size-full flex-col items-center justify-center gap-5 rounded-2xl border border-[#C98A1C]/15 bg-white/90 p-5 backdrop-blur-md shadow-lg shadow-black/5",
    },
  },
  defaultVariants: {
    variant: "light",

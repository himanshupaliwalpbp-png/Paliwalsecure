...
/* ────────────────────────────────────────────────────────────────────────────
   SkyToggle — Beautiful day/night toggle with clouds, stars, sun & moon
   Integrated with next-themes via useSafeTheme
   ──────────────────────────────────────────────────────────────────────────── */
...
export default function SkyToggle() {
  ...
  if (!mounted) {
    return <div className="h-[32px] w-[72px] rounded-full bg-white/10 animate-pulse" aria-hidden="true" />;
  }

...
const STATS = [
  ...
  { icon: CheckCircle2, value: '98%', labelEn: 'Claims', labelHi: 'क्लेम', labelHinglish: 'Claims' },
  { icon: Users, value: '500+', labelEn: 'Families', labelHi: 'परिवार', labelHinglish: 'Families' },

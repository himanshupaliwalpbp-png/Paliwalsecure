          ...
          <div key={i} className="flex items-center flex-1 last:flex-none">
            ...
            <div className="flex flex-col items-center gap-1.5 min-w-[60px]">
              <motion.div
                initial={{ scale: 0 }}
                animate={{ scale: 1 }}
                transition={{ delay: i * 0.1, type: 'spring' as const, damping: 15 }}
        ...
        <div className="flex gap-2">
          <div className="flex-1 relative">
            <Input
              ...
              className="glass border-slate-200 dark:border-white/10 pr-10 h-11"
              data-cursor-hover
            ...
            >
              ...
              <div className={`rounded-xl p-4 border ${currentStatus.bgClass}`}>
                ...
                <motion.div
                  ...
                  initial="hidden"
                  animate="visible"
                  className="mt-3 pt-3 border-t border-slate-200 dark:border-white/5"
                >

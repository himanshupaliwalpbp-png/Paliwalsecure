            ...
            {uploadState === 'selected' && (
              ...
              >
                <Button
                  ...
                  className="flex-1 btn-ripple bg-gradient-to-r from-[#C98A1C] to-[#0A1330] hover:from-[#0A1330] hover:to-[#0F1C40] text-white rounded-xl gap-2 h-11 sm:h-12 font-semibold shadow-lg shadow-[#C98A1C]/20 hover:shadow-[#C98A1C]/35 transition-all duration-300 text-sm sm:text-base"
                  size="lg"
                >

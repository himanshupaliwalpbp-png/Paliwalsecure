...
export function WhatsAppFAB({ className = '' }: WhatsAppFABProps) {
  ...
  return (
    <div
      // Desktop-only: floating WhatsApp FAB is hidden on mobile to reduce
      // clutter. Mobile users access WhatsApp via the header menu, footer,
      // and dedicated /whatsapp page.
      className={`hidden md:flex fixed bottom-6 left-4 md:left-6 z-[55] ${className}`}
    ...
    >
      ...
      >
        ...
        {/* Notification dot removed — was showing "1" persistently on every page */}

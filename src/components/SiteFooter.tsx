...
const COMPLIANCE_LINKS = [
  ...
  { href: '/editorial-policy', labelKey: 'footer.link.editorialPolicy' },
  { href: '/review-policy', labelKey: 'footer.link.reviewPolicy' },
  { href: '/fact-checking-policy', labelKey: 'footer.link.factCheckingPolicy' },
  { href: '/corrections-policy', labelKey: 'footer.link.correctionsPolicy' },
  { href: '/sources-policy', labelKey: 'footer.link.sourcesPolicy' },
  { href: '/ai-usage-policy', labelKey: 'footer.link.aiUsagePolicy' },

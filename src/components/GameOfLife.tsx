          ...
          {currentScenario && (
            ...
            >
              <Card className="border-0 shadow-xl overflow-hidden">
                ...
                <div className="bg-gradient-to-r from-slate-800 to-slate-700 dark:from-slate-700 dark:to-slate-600 p-3 sm:p-6 text-white">
                    ...
                    {(() => {
                      ...
                      return (
                        <div className="shrink-0 w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-white/10 flex items-center justify-center">
                          <Icon className="w-5 h-5 sm:w-6 sm:h-6 text-white/80 dark:text-white/80" />
                        </div>
                      );
                    })()}
                  </div>
                  <p className="mt-2 text-sm text-slate-300 dark:text-slate-300 leading-relaxed">

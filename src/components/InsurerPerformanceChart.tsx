        ...
        return (
          <div key={idx} className="flex items-center gap-1.5">
            <span
              ...
              style={{
                backgroundColor: isIcr ? 'rgba(0,0,0,0)' : entry.color,
                borderColor: isIcr ? entry.color : 'rgba(0,0,0,0)',
  ...
  return (
    ...
    >
      <Card className="overflow-hidden border-0 shadow-xl rounded-2xl bg-card">
        {/* Gradient Header */}
        <div className="bg-gradient-to-r from-emerald-600 via-[#C98A1C] to-[#C98A1C] px-6 py-5">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div className="flex items-center gap-3 text-white">
              ...
              <div>
                <h3 className="font-bold text-lg">{t('insurerChart.badge')}</h3>
                <p className="text-white/80 text-xs">
                  {t('insurerChart.heading')}
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <Select value={selectedInsurer} onValueChange={setSelectedInsurer}>
                ...
                <SelectContent>
                  <SelectItem value="all">{t('insurerChart.compare')}</SelectItem>
                  {INSURERS.map((ins) => (
        ...
        <CardContent className="p-4 sm:p-6">
          ...
          <AnimatePresence mode="wait">
            {selectedInsurer !== 'all' && currentInsurer && csrTrend && icrTrend && (
              ...
              >
                {/* CSR Quick Stat */}
                <div className="rounded-xl border border-border bg-gradient-to-br from-emerald-50/50 to-amber-50/50 dark:from-emerald-950/20 dark:to-amber-950/20 p-3 sm:p-4">
          ...
          <div className="flex items-start gap-2 mt-4 mb-6 px-1">
            ...
            <p className="text-[11px] text-muted-foreground leading-relaxed">
              {selectedInsurer === 'all'
                ? t('insurerChart.csr')
                : `${t('insurerChart.csr')} & ${t('insurerChart.icr')}`}
            </p>
          </div>
          ...
          >
            ...
            <p className="text-[10px] text-muted-foreground/70 leading-relaxed">
              Data source: IRDAI Annual Reports. {t('insurerChart.csr')} & {t('insurerChart.icr')}
            </p>
          </motion.div>
        </CardContent>
      </Card>
